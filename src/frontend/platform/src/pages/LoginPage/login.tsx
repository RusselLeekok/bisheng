    ...
    return <div className='w-full h-full bg-background-dark'>
        <div className='fixed z-10 sm:w-[1280px] w-full sm:h-[720px] h-full translate-x-[-50%] translate-y-[-50%] left-[50%] top-[50%] border rounded-lg shadow-xl overflow-hidden bg-background-login'>
            <div className='w-[420px] h-[704px] m-[8px] hidden sm:block relative z-20'>
                <img src={brand.logos.loginBig} alt="logo_picture" className='w-full h-full dark:hidden' />
                <img src={brand.logos.loginDark} alt="logo_picture" className='w-full h-full hidden dark:block' />
            ...
            <div className='absolute w-full h-full z-10 flex justify-end top-0'>
                <div className='w-[852px] sm:px-[266px] px-[20px] pyx-[200px] bg-background-login relative'>
                    <div>
                        <img src={brand.logos.loginSmall} className="block w-[114px] h-[36px] m-auto mt-[140px] dark:w-[124px] dark:pr-[10px] dark:hidden" alt="" />
                        <img src={brand.logos.loginSmallDark} className="w-[114px] h-[36px] m-auto mt-[140px] dark:w-[124px] dark:pr-[10px] dark:block hidden" alt="" />
                    ...
                    <div className=" absolute right-[16px] bottom-[16px] flex">
                        {brand.version.show && (
                            <span className="mr-4 text-sm text-gray-400 relative top-2">
                                {brand.version.label}{brand.version.prefix}{json.version}
                            </span>
                        )}
                        {!appConfig.noFace && <div className='help flex'>
                            {brand.links.showGithub && (
                                <a href={brand.links.github} target="_blank">
                            ...
                            {brand.links.showDocs && (
                                <a href={brand.links.docs} target="_blank">
